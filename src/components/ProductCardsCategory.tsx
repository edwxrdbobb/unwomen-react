...
const ProductCardCategory = ({category, size}) => {
                    ...
                    <div className="backdrop-blur-sm bg-white/30 rounded-lg overflow-hidden shadow-sm 
                      ...
                      <div className="p-4" style={{lineHeight: 1}}>
                        ...
                        <div className="flex items-center justify-between text-sm text-gray-600">
                          ...
                          <Link href={`/products/shop/category/${product.category}`} passHref>
                            <span className="bg-yellow-100 p-1 rounded-full" style={{fontSize: 10}}>{product.category}</span>
                          </Link>
                        </div>
                      </div>
                    </div>
